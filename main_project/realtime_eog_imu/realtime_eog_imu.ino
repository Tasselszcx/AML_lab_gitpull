...
const int enable_up    = 1; // [EOG开关] 向上看 -> 滚轮向上
const int enable_down  = 1; // [EOG开关] 向下看 -> 滚轮向下
const int enable_left  = 1; // [EOG开关] 向左看 -> 鼠标右键
const int enable_right = 1; // [EOG开关] 向右看 -> (预留功能)

// ==========================================================
// 🕹️ 2. IMU 灵敏度与死区调参区
// ==========================================================
float sensitivity_x = 0.05; // X轴灵敏度 (默认 0.05，数值越大移动越快)
float sensitivity_y = 0.05; // Y轴灵敏度 (默认 0.05)
int deadzone = 60;          // 死区阈值 (默认 60，过滤静止时的轻微抖动)
